...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T> {
	...
	public String toString() {
		String out = "";
		out = recFormatTree(root,"");
		return out;
	}
	
	private String recFormatTree(BinaryTreeNode<T> here,String space) {
		if (here == null) return "";
		return recFormatTree(here.getRight(),space +"\t")+space+here.getData()+"\n" + recFormatTree(here.getLeft(),space +"\t");
	}
